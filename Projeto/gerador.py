...
# Parâmetros
num_vertices = 2000  # Número de vértices no grafo
probabilidade_conexao = 0.8  # Probabilidade de haver uma aresta entre dois vértices (ajuste conforme necessário)
